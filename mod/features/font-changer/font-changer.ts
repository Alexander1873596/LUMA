...
async function updateFont() {
  const savedFontValue = await window.LumaCloudMod.getStorageValue("font-changer/savedFont");
  const fontChangerEnabled = await window.LumaCloudMod.getStorageValue("font-changer/enabled");
