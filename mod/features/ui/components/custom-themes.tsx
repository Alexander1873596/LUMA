...
export function CustomThemes() {
  ...
  useEffect(() => {
    (async () => {
      const colorsEnabled = await (window as any).LumaCloudMod.getStorageValue("custom-themes/enabled");
      const accentColor = await (window as any).LumaCloudMod.getStorageValue("custom-themes/accent");
      const playerColorsReplaceEnabled =
        (await (window as any).LumaCloudMod.getStorageValue("custom-themes/playerColorsReplace")) === false
          ? false
          : true;
      const disableVibeAnimation = await (window as any).LumaCloudMod.getStorageValue(
        "custom-themes/disableVibeAnimation",
      );
      const disableExplicitMark =
        (await (window as any).LumaCloudMod.getStorageValue("custom-themes/disableExplicitMark")) === false
          ? false
          : true;
      const hiddenMenuItems = await (window as any).LumaCloudMod.getStorageValue("custom-themes/hideMenuItems");
            ...
            <Switch
              ...
              onCheckedChange={(value) => {
                if (!value) {
                  ...
                  (window as any).LumaCloudMod.setStorageValue("custom-themes/enabled", value);
                }
              }}
            />
                ...
                <AlertDialogFooter>
                  ...
                  <AlertDialogAction
                    ...
                    onClick={() => {
                      ...
                      (window as any).LumaCloudMod.setStorageValue("custom-themes/enabled", false);
                      setTimeout(() => {
                        location.reload();
                      }, 500);
                    }}
              ...
              {ACCENT_COLORS.map((color) => (
                <button
                  ...
                  onClick={() => {
                    ...
                    (window as any).LumaCloudMod.setStorageValue("custom-themes/accent", color);
                  }}
                  title={color}
                />
              ))}
            ...
            <div className="flex items-center gap-3">
              <Switch
                ...
                onCheckedChange={(value) => {
                  ...
                  (window as any).LumaCloudMod.setStorageValue("custom-themes/playerColorsReplace", value);
                }}
              />
            ...
            <div className="flex items-center gap-3 mt-4">
              <Switch
                ...
                onCheckedChange={(value) => {
                  ...
                  (window as any).LumaCloudMod.setStorageValue("custom-themes/disableVibeAnimation", value);
                }}
              />
            ...
            <div className="flex items-center gap-3 mb-4">
              <Switch
                ...
                onCheckedChange={(value) => {
                  ...
                  (window as any).LumaCloudMod.setStorageValue("custom-themes/disableExplicitMark", value);
                }}
              />
                ...
                <Switch
                  ...
                  onCheckedChange={(value) => {
                    setHiddenMenuItems((prev) => {
                      ...
                      (window as any).LumaCloudMod.setStorageValue("custom-themes/hideMenuItems", newHiddenMenuItems);
