...
export function Devtools() {
  ...
  useEffect(() => {
    (async () => {
      setDevtoolsEnabled((await window.LumaCloudMod.getStorageValue("devtools/enabled")) || false);
      setSystemToolbarEnabled((await window.LumaCloudMod.getStorageValue("devtools/systemToolbar")) || false);
    })();
  }, []);
        ...
        <div className="flex items-center gap-3">
          <Switch
            ...
            onCheckedChange={(enabled) => {
              ...
              window.LumaCloudMod.setStorageValue("devtools/enabled", enabled);
            }}
          />
        ...
        <div className="flex items-center gap-3">
          <Switch
            ...
            onCheckedChange={(enabled) => {
              ...
              window.LumaCloudMod.setStorageValue("devtools/systemToolbar", enabled);
            }}
          />
