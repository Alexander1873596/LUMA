...
export function ScaleChanger() {
  ...
  useEffect(() => {
    (async () => {
      const savedScale = await window.LumaCloudMod.getStorageValue("scale-changer/savedScale");
      if (!savedScale) window.LumaCloudMod.setStorageValue("scale-changer/savedScale", 1);
      ...
      <div className="flex flex-col gap-4 pt-2 px-3 items-center justify-center">
        <div className="flex gap-3 items-center w-full">
          ...
          <Button
            ...
            onClick={() => {
              setCustomScale(1);
              window.LumaCloudMod.setStorageValue("scale-changer/savedScale", 1);
            }}
          >
            Сбросить
          </Button>
        ...
        <Slider
          ...
          onValueChange={(value) => {
            ...
            window.LumaCloudMod.setStorageValue("scale-changer/savedScale", value[0]!);
          }}
        />
      </div>
    </ExpandableCard>
