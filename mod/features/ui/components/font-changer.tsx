...
export function FontChanger() {
  ...
  useEffect(() => {
    (async () => {
      let savedFont = await window.LumaCloudMod.getStorageValue("font-changer/savedFont");
      savedFont = availableFonts.find((font) => font === savedFont) || availableFonts[0];
      const savedFontEnabled = (await window.LumaCloudMod.getStorageValue("font-changer/enabled")) || false;
        ...
        <div className="flex items-center gap-3">
          <Switch
            ...
            onCheckedChange={(enabled) => {
              ...
              window.LumaCloudMod.setStorageValue("font-changer/enabled", enabled);
            }}
          />
          ...
          <div className="flex gap-4 items-center justify-center">
            ...
            <Select
              ...
              onValueChange={(value: string) => {
                setCustomFont(value);
                window.LumaCloudMod.setStorageValue("font-changer/savedFont", value);
              }}
