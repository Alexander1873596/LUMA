...
const BOOSTY_URL = "https://boosty.to/LumaCloud";
const GITHUB_REPO_URL = "https://github.com/Stephanzion/LumaCloudBetaMod/";
  ...
  const appMetaQuery = useQuery({
    ...
    queryFn: async () => {
      const data = await fetch(
        "https://raw.githubusercontent.com/Stephanzion/LumaCloudBetaMod/refs/heads/master/.meta/meta.json",
      );
      if (data.status !== 200) {
