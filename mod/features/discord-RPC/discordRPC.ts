...
(async () => {
  isRpcEnabled = (await window.LumaCloudMod.getStorageValue("discordRPC/enabled")) === false ? false : true;
  showModButton = (await window.LumaCloudMod.getStorageValue("discordRPC/showModButton")) === false ? false : true;
})();
